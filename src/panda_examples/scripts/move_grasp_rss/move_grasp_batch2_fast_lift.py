...
class MoveGrasp(object):
    def __init__(self):
        ...
        self.lift_height = 0.1 #in m, for 3rd movement in data_collection
        self.f = None
    ...
    def trajectory_saver(self, z):
        height = int(z.data[1:]) #in mm, 330 260 285 for the batch objects
        self.routine_lock()
        if not self.is_moveit_inited:
            self.move_it_init()
        ...
        self.cartesian_plan_save_execute(1.0, [0.4,0,height/1000.0+self.lift_height],[0.5**0.5, -(0.5**0.5),0,0],'v2_obj_5cm_'+str(height)+'.yaml')
        self.go_to_joint_pose([0,-0.221883,0,-2.70201,0,2.4795,1.5707963])
        self.routine_unlock()
    ...
    def move_to_obj_height(self, data):
        ...
        if not self.is_moveit_inited:
            self.move_it_init()
        self.go_to_joint_pose([0,-0.221883,0,-2.70201,0,2.4795,1.5707963])
        self.load_plan_execute('/home/crslab/franka_traj_faster_lift/v2_fakehome_obj_'+str(height)+'.yaml')
    ...
    def data_collection_routine(self, data):
        ...
        self.load_plan_execute('/home/crslab/franka_traj_faster_lift/v2_obj_preproph_'+str(height)+'.yaml')
        ...
        rospy.sleep(0.5)
        cur_time = time.time()
        self.load_plan_execute('/home/crslab/franka_traj_faster_lift/v2_preproph_obj_'+str(height)+'.yaml')
        ...
        cur_time = time.time()
        self.load_plan_execute('/home/crslab/franka_traj_faster_lift/v2_obj_5cm_'+str(height)+'.yaml')
