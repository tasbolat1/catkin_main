...
echo_and_run cd "/home/crslab/catkin_main/src/robotiq_2finger_grippers/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/crslab/catkin_main/build/robotiq_2finger_grippers/robotiq_modbus_tcp" \
    install \
    $DESTDIR_ARG \
