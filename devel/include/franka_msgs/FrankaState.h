...
struct FrankaState_
{
  ...
  FrankaState_()
    ...
    , last_motion_errors()  {
      ...
      cartesian_velocity.assign(0.0);

      quarternion_state.assign(0.0);
  }
  ...
  _EE_T_K_type EE_T_K;
   ...
   typedef boost::array<double, 42>  _jacobian_type;
  _jacobian_type jacobian;

   typedef boost::array<double, 6>  _cartesian_velocity_type;
  _cartesian_velocity_type cartesian_velocity;

   typedef boost::array<double, 4>  _quarternion_state_type;
  _quarternion_state_type quarternion_state;
...
// {'franka_msgs': ['/home/crslab/catkin_main/src/franka_ros/franka_msgs/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
struct MD5Sum< ::franka_msgs::FrankaState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x156d28d740f51f6aULL;
  static const uint64_t static_value2 = 0xcc5737d2cef778d8ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::franka_msgs::FrankaState_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.quarternion_state);
      stream.next(m.time);
...
struct Printer< ::franka_msgs::FrankaState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::franka_msgs::FrankaState_<ContainerAllocator>& v)
  {
    ...
    s << indent << "quarternion_state[]" << std::endl;
    for (size_t i = 0; i < v.quarternion_state.size(); ++i)
    {
      s << indent << "  quarternion_state[" << i << "]: ";
      Printer<double>::stream(s, indent + "  ", v.quarternion_state[i]);
    }
    s << indent << "time: ";
