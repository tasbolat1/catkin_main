...
(cl:defclass <FrankaState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   :initform (cl:make-array 6 :element-type 'cl:float :initial-element 0.0))
   (quarternion_state
    :reader quarternion_state
    :initarg :quarternion_state
    :type (cl:vector cl:float)
...
(cl:defmethod jacobian-val ((m <FrankaState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-msg:jacobian-val is deprecated.  Use franka_msgs-msg:jacobian instead.")
  (jacobian m))

(cl:ensure-generic-function 'cartesian_velocity-val :lambda-list '(m))
(cl:defmethod cartesian_velocity-val ((m <FrankaState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-msg:cartesian_velocity-val is deprecated.  Use franka_msgs-msg:cartesian_velocity instead.")
  (cartesian_velocity m))

(cl:ensure-generic-function 'quarternion_state-val :lambda-list '(m))
(cl:defmethod quarternion_state-val ((m <FrankaState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader franka_msgs-msg:quarternion_state-val is deprecated.  Use franka_msgs-msg:quarternion_state instead.")
  (quarternion_state m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FrankaState>) ostream)
  ...
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-double-float-bits ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream)))
   (cl:slot-value msg 'quarternion_state))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FrankaState>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'EE_T_K)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:aref vals i) (roslisp-utils:decode-double-float-bits bits)))))
  (cl:setf (cl:slot-value msg 'jacobian) (cl:make-array 42))
  (cl:let ((vals (cl:slot-value msg 'jacobian)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:aref vals i) (roslisp-utils:decode-double-float-bits bits)))))
  (cl:setf (cl:slot-value msg 'cartesian_velocity) (cl:make-array 6))
  (cl:let ((vals (cl:slot-value msg 'cartesian_velocity)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:aref vals i) (roslisp-utils:decode-double-float-bits bits)))))
  (cl:setf (cl:slot-value msg 'quarternion_state) (cl:make-array 4))
  (cl:let ((vals (cl:slot-value msg 'quarternion_state)))
    (cl:dotimes (i 4)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FrankaState>)))
  ...
  "156d28d740f51f6acc5737d2cef778d8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FrankaState)))
  "Returns md5sum for a message object of type 'FrankaState"
  "156d28d740f51f6acc5737d2cef778d8")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FrankaState>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'jacobian) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'cartesian_velocity) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'quarternion_state) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 8)))
     8
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <FrankaState>))
  ...
  (cl:list 'FrankaState
    ...
    (cl:cons ':quarternion_state (quarternion_state msg))
