...
class FrankaState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('jacobian')) {
        ...
        this.jacobian = new Array(42).fill(0);
      }
      if (initObj.hasOwnProperty('cartesian_velocity')) {
        this.cartesian_velocity = initObj.cartesian_velocity
      }
      else {
        this.cartesian_velocity = new Array(6).fill(0);
      }
      if (initObj.hasOwnProperty('quarternion_state')) {
        this.quarternion_state = initObj.quarternion_state
      }
      else {
        this.quarternion_state = new Array(4).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [jacobian] has the right length
    if (obj.jacobian.length !== 42) {
      throw new Error('Unable to serialize array field jacobian - length must be 42')
    }
    // Serialize message field [jacobian]
    bufferOffset = _arraySerializer.float64(obj.jacobian, buffer, bufferOffset, 42);
    // Check that the constant length array field [cartesian_velocity] has the right length
    if (obj.cartesian_velocity.length !== 6) {
      throw new Error('Unable to serialize array field cartesian_velocity - length must be 6')
    }
    // Serialize message field [cartesian_velocity]
    bufferOffset = _arraySerializer.float64(obj.cartesian_velocity, buffer, bufferOffset, 6);
    // Check that the constant length array field [quarternion_state] has the right length
    if (obj.quarternion_state.length !== 4) {
      throw new Error('Unable to serialize array field quarternion_state - length must be 4')
    }
    // Serialize message field [quarternion_state]
    bufferOffset = _arraySerializer.float64(obj.quarternion_state, buffer, bufferOffset, 4);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.jacobian = _arrayDeserializer.float64(buffer, bufferOffset, 42)
    // Deserialize message field [cartesian_velocity]
    data.cartesian_velocity = _arrayDeserializer.float64(buffer, bufferOffset, 6)
    // Deserialize message field [quarternion_state]
    data.quarternion_state = _arrayDeserializer.float64(buffer, bufferOffset, 4)
  ...
  static md5sum() {
    ...
    return '156d28d740f51f6acc5737d2cef778d8';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.jacobian !== undefined) {
      ...
      resolved.jacobian = new Array(42).fill(0)
    }
    ...
    if (msg.cartesian_velocity !== undefined) {
      ...
      resolved.cartesian_velocity = new Array(6).fill(0)
    }

    if (msg.quarternion_state !== undefined) {
      resolved.quarternion_state = msg.quarternion_state;
    }
    else {
      resolved.quarternion_state = new Array(4).fill(0)
    }
